# Signal Bridge Historical Issue Archive (v0.4-v0.6)

This archive preserves resolved, improved, planned, and superseded issue records from the original public tracker through Signal Bridge v0.6. For current open issues, see [ISSUES.md](../../ISSUES.md).

## Resolved and historical records
